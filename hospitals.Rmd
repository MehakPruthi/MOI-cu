...
SCENARIO_YEAR <- 2016 # TODO: Replace with user-defined input from visualization tool
...
USER_NEW_LTC_CAP_CSD <- tibble(csduid = c(3506008, 3519049), added.ltc.cap = c(0, 0)) # TODO: Replace with user-defined input from visualization tool
...
if (DECISION_MAKING) {  
  new_hospital <- moh_new_hospitals(overburden_csd_hosp_new, treso_zone_system, treso_population_moh_agecluster, treso_centroids,
                                    new_hospital_user, MIN_BEDS_TOGGLE, SCENARIO_YEAR)
} else {
