...
proj_param <- treso_population_long %>% 
  left_join(HBAMprojected_alos, by = c('age_cluster', 'year')) %>% 
...
crm2hbam <- left_join(crm_treso_tbl, HBAM_proj_scale, by = c('id', 'hospitalname' = 'name', 'pcode', 'hosp.treso.zone', 'caretype', 'age_cluster')) %>% 
