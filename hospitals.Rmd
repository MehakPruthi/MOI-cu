...
# #CIHI Bed Data ##Salah Note to Remove to End
...
HBAMprojected_alos_adj <- HBAMprojected_alos %>% 
  ...
  select(year, id, agecluster, caretype, adj.net.hosp.days, adj.caretype.agecluster.los)

saveRDS(HBAMprojected_alos, file = 'cache/moh/HBAMprojected_alos_adj.rds')
