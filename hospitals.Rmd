...
########### Add travel times in from each treso zone to each hospital to determine longest travel times per capita?
########### Then build progressively in each CSD to minimize number of beds built while reducing longest travel times?
########### Is there any reason you can't built a small number of beds per cSD for all CSDs as long as hospitals already exist?
########## Consider having minimum_new_build_beds vs. minimum_expand_existing_beds
# OR
########### ONCE BEDS BUILT AT NEW CSDs, SEE WHICH CSDs still over burdened;
########### SEE HOW MUCH each CSD is overburdened by - measure sum of beds needed by caretype
