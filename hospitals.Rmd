...
#ADD CSD AND PCODE DATA FOR LTC AND ALC SITES
ltc_homes <- ltc_homes %>% 
...
test <- crm_treso_tbl_calc %>% filter(id == 80, 
                                      caretype != "AM") %>% select(hospitalname, id, caretype, age_cluster, 
