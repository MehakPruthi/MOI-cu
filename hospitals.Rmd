...
LTC_OP_DAYS <- 365
USER_INPUT_COST_PER_BED <- 1000000
USER_INPUT_BASE_HOSP_COST <- 50000000
...
```{r}
result <- forecast_scenario_alc_calculation(treso_population_moh, ltc_turnover_raw, new_ltc_cap_csd, hospitallocations_tz, 
...
result <- forecast_scenario_crm_calculation(treso_population_moh_agecluster, treso_origin_cases, hospital_lookup_master, 
                                            HBAMprojected_alos_adj, crm_treso, ALC_proj_cd, CARETYPE_LIST, AGE_CLUSTER_LIST, 
...
result <- format_demand_output(treso_zone_system, treso_population_moh_agecluster, travel_time_skim,
