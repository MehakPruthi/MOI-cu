...
decision_making <- FALSE # TODO: Replace with value from user from visualization tool
...
hospital_wide <- crm_demand %>% 
  ...
  mutate(utilization.AM = 0,
         ...
         utilization.AT.existing = beds.needed_AT / beds.existing.AT,
         utilization.CR.existing = beds.needed_CR / beds.existing.CR,
         utilization.GR.existing = beds.needed_GR / beds.existing.GR,
         utilization.MH.existing = beds.needed_MH / beds.existing.MH) %>%
