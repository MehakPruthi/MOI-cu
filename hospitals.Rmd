...
ct <- 'am'
a <- 'ad'
assign(paste0(ct,"_proj_origin_", a), readRDS(paste0('cache/hospitals/', ct, '_proj_origin_', a,'.rds')))
...
proj_odv_rcall <- function(ct, a) {
  ...
  return(proj_origin, proj_origin_full, proj_destination, proj_destination_full)
}
