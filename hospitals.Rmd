...
at_sim_matrix_ad <- left_join(at_matrix_long_ad, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
...
# Aggregate Origin back to CSD
at_sim_matrix_ped <- left_join(at_matrix_long_ped, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
cr_sim_matrix_ad <- left_join(cr_matrix_long_ad, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
cr_sim_matrix_ped <- left_join(cr_matrix_long_ped, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
gr_sim_matrix_ad <- left_join(gr_matrix_long_ad, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
gr_sim_matrix_ped <- left_join(gr_matrix_long_ped, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
mh_sim_matrix_ad <- left_join(mh_matrix_long_ad, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
mh_sim_matrix_ped <- left_join(mh_matrix_long_ped, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
...
# Aggregate Origin back to CSD
am_sim_matrix_ped <- left_join(am_matrix_long_ped, treso_zone_system, by = c('origin' = 'treso_id')) %>% 
  select(-area, -mof_region) %>% 
  filter(!is.na(csduid)) %>% 
  ungroup() %>% 
  group_by(csduid, destination) %>% 
