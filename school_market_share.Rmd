...
schoolEnrol2011 <- schoolEnrolSlim %>%
  ...
  mutate(MSerror2011 = abs(ade - enrol2011.by2007MS) / ade, 
         MSerrorPercent2011 = percent(abs(ade - enrol2011.by2007MS) / ade, accuracy = 1)) %>%
...
schoolEnrol20112017 <- schoolEnrol2011 %>%
  ...
  arrange(sfis) %>%
  saveRDS("cache/edu/school_2017_market_share.rds")
