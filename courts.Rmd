...
treso_shp_sp <- readOGR(dsn = "input/treso", layer = "TRESO_Zones_SocioData_Gatineau_LCC")
treso_projarg = treso_shp_sp@proj4string@projargs
...
travel_distance_skim <- readRDS("cache/treso/treso_distance_2016.rds")
...
results <- distribute_mag_demand(future_cases_bl_treso, courthouse_master, new_courthouse, 
