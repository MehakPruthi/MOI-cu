...
# Assign a fraction of demand to be distributed to their closest courthouse in the CD
CLOSEST_PERCENTAGE <- 0.8

# Assign a fraction of demadn to be distributed to a random courthouse (of appropriate casetype) in the CD, weighted by # of courtrooms
...
results <- distribute_mag_demand(future_cases_bl_treso, courthouse_asset, new_courthouse, treso_shp, travel_time_skim,
                                 MODERNIZATION_FACTOR, APPEARANCE_FACTOR, DISTRIBUTION_PERCENTAGE, U_AVG, MODEL_YEAR)
