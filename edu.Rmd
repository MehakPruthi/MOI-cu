...
# Identify schools in unconsolidated zones
# unconsolidated_schools <- schools_consolidated %>% 
#   right_join(select(unconsolidate_treso_por, treso.id.por), by = c('treso.id.pos' = 'treso.id.por')) %>% 
#   right_join(select(unconsolidate_treso_pos, treso.id.pos), by = c('treso.id.pos'))
