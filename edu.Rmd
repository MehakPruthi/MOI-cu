...
# Before this was reading a file in input/school_historical_ade.csv
# TODO not sure how that file is different from school_capacity.csv. Ask Alec

school_ade_2017 <- readRDS("output/school_capacity_2017.rds")
```
...
for (dist in percentile_dist) {
  ...
  school_tb <- summarize_buffered_zones(buffered_df, treso_tb, school_ade_2017, school_board_def, treso_zone_def) %>%
...
school_of_interest <- "Thomas Merton (O) CSS"
...
school_tb <- readRDS("output/school_tb_50.rds")
...
# TODO: explore ridiculously low values of enrolment and consider removing these schools
