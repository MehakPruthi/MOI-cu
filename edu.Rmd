...
result <- distribute_students_to_schools(school_20xx, new_school, por, pos_full, prop_matrix, is_weight_continuous=TRUE)
...
df_list <- distribution_model(school_base, school_20xx, school_summary_2017, school_summary_20xx, prop_matrix,
                                            ...
                                            overfill_threshold = 2000, capacity_constrained = CAPACITY_CONSTRAINED)
...
school_forecast <- distribution_model(school_base, filter(school_20xx, is.consolidated == 0), school_summary_2017, 
                                      ...
                                      overfill_threshold = 2000, capacity_constrained = TRUE) 
