...
new_school <- new_school %>% 
  ...
  # Revise OTG of new schools to account for OTG closed by consolidating existing schools in the CSD - NOT NEEDED SINCE RERUNNING TO CHECK NEW UNCONSTRAINED ADE WILL BE USED TO DETERMINE HOW TO SIZE ADE
