...
#Alpha, Beta, CR, & avg. TT at the bottom of this chunk
...
pos_school_weight_3 <- pos_school_weight_2_EPE %>%
  group_by(treso.id.pos) %>%
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_EPS %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_ECE %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_ECS %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_FPE %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_FPS %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_FCS %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
...
# get treso zone school.weight totals
pos_school_weight_3 <- pos_school_weight_2_FCE %>%
  group_by(treso.id.pos) %>%
  summarise(school.weight.total = sum(school.weight))
