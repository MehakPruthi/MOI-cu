...
school_forecast_final <- distribution_model(school_base, school_20xx, school_summary_2017, school_summary_20xx, prop_matrix,
...
```{r}
# Reassign ADE from deleted schools based on TRESO origin distribution propensity matrix
school_summary_20xx <- distribute_students_to_schools(school_forecast, new_school_iteration, por, pos_full, prop_matrix,
                                                      is_weight_continuous = FALSE)[[1]]


# Rerun steps 3, 4 until treshoold (takes about 55 iterations for 100 threshold)
school_forecast <- distribution_model(school_base, school_20xx, school_summary_2017, school_summary_20xx, prop_matrix,
                                      prop_matrix_balanced, new_school_iteration, pos, pos_full,
