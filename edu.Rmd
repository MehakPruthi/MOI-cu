...
# a.	If net new OTG (per CSD) is less than the minimum required for a new school, or if no school in CSD, don’t build school and ignore ‘need’ for more capacity
