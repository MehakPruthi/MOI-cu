...
df_list <- distribution_model(school_base, school_20xx, school_summary_2017, school_summary_20xx, prop_matrix,
                              prop_matrix_balanced, new_school=NULL, pos, pos_full,
...
prop_matrix_balanced <- matrix_balancing_2d(prop_matrix, por, pos, totals_to_use="rows", max_iterations = 1000)
...
school_forecast <- distribution_model(school_base, filter(school_20xx, is.consolidated == 0), school_summary_2017, 
                                      school_summary_20xx, prop_matrix,
                                      prop_matrix_balanced, new_school_iteration, pos, pos_full,
...
school_forecast_final <- distribution_model(school_base, filter(school_20xx, is.consolidated == 0), school_summary_2017,
                                            school_summary_20xx, prop_matrix, prop_matrix_balanced, new_school_iteration, pos,
                                            pos_full, overfill_threshold=20000, max_iter=10, USER_OTG_THRESHOLD, capacity_constrained=TRUE)[[1]]

school_forecast_final_old <- school_forecast_final
school_forecast_final <- school_forecast_final_old

school_forecast_final <- school_forecast_final %>% 
