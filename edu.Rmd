...
#alpha: 0.109975007710853
#beta: -0.0883606111493988
#cr: 0.821382426165921
# simualted average travel time:  6.46776866680929
# Observed average travel time: 6.49770853866524
```
...
prop_matrix2_EPS <- matrix_balancing(prop_matrix_EPS, por_full, pos_full, "rows", 1000, 0.001)
...
prop_matrix2_ECE <- matrix_balancing(prop_matrix_ECE, por_full, pos_full, "rows", 1000, 0.001)
...
prop_matrix2_ECS <- matrix_balancing(prop_matrix_ECS, por_full, pos_full, "rows", 1000, 0.001)
...
prop_matrix2_FPE <- matrix_balancing(prop_matrix_FPE, por_full, pos_full, "rows", 1000, 0.001)
...
prop_matrix2_FPS <- matrix_balancing(prop_matrix_FPS, por_full, pos_full, "rows", 1000, 0.001)
...
prop_matrix2_FCS <- matrix_balancing(prop_matrix_FCS, por_full, pos_full, "rows", 1000, 0.001)
...
prop_matrix2_FCE <- matrix_balancing(prop_matrix_FCE, por_full, pos_full, "rows", 1000, 0.001)
...
ggplot(data=result_school2.data) +
  ...
  facet_wrap(~ mof_region, scale = "fixed") +
  theme(legend.position = "none") + 
  labs(x="Enrollment Difference (Count)", y="Percent Difference (%)", subtitle="Secondary - French Public", title="Closest School vs. Observed Demand (2017)")
