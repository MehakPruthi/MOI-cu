...
result <- distribute_students_to_schools(school_20xx, new_school=NULL, por, pos_full, prop_matrix, is_weight_continuous=TRUE)
...
school_summary_20xx_final <- forecast_school_ade(prop_matrix, trip_list, school_20xx, eqao_2017, new_school)[[1]]
...
school_summary_20xx <- distribute_students_to_schools(filter(school_20xx, is.consolidated == 0), new_school_iteration,
                                                      por, pos_full, prop_matrix, is_weight_continuous = FALSE)[[1]]
...
# Produce the simulated ADE for each school within each TRESO zone
school_summary_20xx_final <- forecast_school_ade(prop_matrix, trip_list, filter(school_20xx, is.consolidated == 0), eqao_2017, new_school_iteration)[[1]]
