...
## Exploration of demand modelling {.tabset .tabset-fade}
...
ggsave(file = "output/tlfd_closest_school_probability.png", plot_travel_time_tlfd(result_student_tlfd), height = 28, width = 10)
