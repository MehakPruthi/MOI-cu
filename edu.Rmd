...
```{r spatial gymnastics, eval = FALSE, echo = FALSE}
cathcment_dist = c('90', '80', '70', '50')
for (dist in cathcment_dist) {
...
```{r extract the 90th catchment for plot, echo = FALSE}
# Create overlays for the 90th catchment distance
student_overlay_90 <- create_overlay(student_xy_90, treso_shp, "student")
```
...
ggplot(linreg, aes(y = ade_2011, x = n_sec_pop_sum)) +
