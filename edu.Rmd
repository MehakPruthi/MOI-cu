...
USER_OTG_THRESHOLD = 1.0 # Percentage of current OTG
CAPACITY_CONSTRAINED = TRUE # User input for capacity constraint
...
### Step 5 - Re-balance, and Summarize Results from Iteration
