...
prop_matrix_EPS_2011 <- readRDS("cache/cfunc_EPS.rds") #read prop_matrix_EPS from output file and jump to matrix balancing
...
trip_list_EPS_2011 <- melt(prop_matrix2_EPS_2011) %>%
  arrange(Var1, Var2)
colnames(trip_list_EPS_2011) <- c('treso.id.por', 'treso.id.pos', 'trips')
...
pos_school_weight <- calculate_school_weight_forecasting(trip_list_EPS_2011_sum, temptemp, eqao_2017, 
...
results_EPS <- by(trip_list_EPS_2011$trips, trip_list_EPS_2011[c("treso.id.pos")], smart_round, simplify = TRUE)
