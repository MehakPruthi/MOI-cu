...
min_tt_threshold <- 150 # TODO:Replace this with value provided by user through the visualization interface?
...
df_list <- edu_dm(travel_time_skim, trip_list, travel_time_threshold_factor, zone_proximity_threshold)
build_df <- df_list[[1]]
