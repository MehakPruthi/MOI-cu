...
# Return the TRESO zone numbers to the rounded matrix
...
# Consider using rbind after sorting instead of left_join()
trip_list2 <- left_join(trip_list, df, by=c("treso.id.por", "treso.id.pos")) %>%
  filter(trips != 0)
