...
school_master_base <- school_master %>% 
...
schools_closed <- school_master_base %>% 
...
school_summary_2017 <- distribute_students_to_schools(school_master, new_school=NULL, por, pos_full, prop_matrix,
                                                      year_id, panel_id, board_id, is_weight_continuous = TRUE)
...
school_summary_20xx <- distribute_students_to_schools(school_master, new_school, por, pos_full, prop_matrix,
                                                      year_id, panel_id, board_id, is_weight_continuous=TRUE)
...
trip_list_schools_summary_difference <- full_join(school_summary_2017, school_summary_20xx, by="sfis", suffix=c(".base", ".20xx")) %>% 
...
school_forecast <- create_forecast_school_list(school_master_base, new_school, panel_id, board_id, 
                                               trip_list_schools_summary_difference, schools_consolidated_closed)
```
...
school_forecast_final <- create_forecast_school_list(school_master_base, new_school, panel_id, board_id,
                                                     trip_list_schools_summary_difference, schools_consolidated_closed)
...
school_summary_20xx <- distribute_students_to_schools(school_master, new_school, por, pos_full, prop_matrix,
                                                      year_id, panel_id, board_id, is_weight_continous=FALSE)
