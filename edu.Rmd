...
prop_matrix <- readRDS("cache/cfunc_ECE.rds")
...
pos_school_weight <- calculate_school_weight_forecasting(trip_list, school_master, eqao_2017, year_id, panel_id, board_id)
...
#user_input_school_size <- 500 # Replace this hard-coded value with user-input value from visualization
#user_input_panel <- 'Elementary' # Replace this hard-coded value with user-input value from visualization
#user_input_pcode <- 'K0h2p0' # Replace this hard-coded value with user-input value from visualization
