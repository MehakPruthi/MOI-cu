...
# Simplify school forecast data (ADE and OTG) to join to historical school data
...
schoolLocCombinedDistinct <- schoolLocCombined %>%
...
# Join TRESO/CSD data to main schools dataframe

school_treso_data <- schoolLocCombined %>%
