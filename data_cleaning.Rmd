...
# TRESO data
hhld_df <- data.table::fread("input/treso/final_households_2016.csv.gz")
pop_df <- data.table::fread("input/treso/final_persons_2016.csv.gz")
...
saveRDS(courthouse_asset_distributed, "cache/mag/courthouse_master.rds")
```
