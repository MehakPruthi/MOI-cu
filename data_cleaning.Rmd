...
# Compile master list of schools, sfis ID, geo coordinates
...
# Remove NA values of lat/long from school location dataframe in order to run x/y retrieval
...
# Join schoolTRESO table to CD/CSD info and then export to CSV
...
saveRDS(schoolTRESOcsd, 'output/school_treso_master.rds')
