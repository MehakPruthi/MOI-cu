...
saveRDS(HBAMhistorical, file = 'cache/moh/HBAMhistorical.rds')
...
saveRDS(HBAMprojected, file = 'cache/moh/hbamprojected.rds')
...
saveRDS(hospitallocations, file = 'cache/moh/hospitallocations.rds')
...
saveRDS(treso_health_tb, file = 'cache/moh/treso_health_tb.rds')
