...
HBAMhistorical_cd_long <- gather(HBAMhistorical_cd_spread, agegroup, totalcases, cases_ag1:cases_ped3) %>% 
  mutate(agegroup = replace(agegroup, agegroup == 'cases_ag1', 1),
         ...
         agegroup = replace(agegroup, agegroup == 'cases_ped1', 1), #Merge 'ped' age groups into 'ag1' bin
         agegroup = replace(agegroup, agegroup == 'cases_ped2', 1),
         agegroup = replace(agegroup, agegroup == 'cases_ped3', 1))
